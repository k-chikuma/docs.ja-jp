...
- [コード サンプルとスニペットaaaa](https://github.com/dotnet/samples)
...
.NET ドキュメントの改善と完成に役立つご協力をお待ちしています。ご投稿いただく場合は、[.NET コミュニティの共同作成者用のプロジェクトaaaa](https://github.com/dotnet/docs/projects/35)でさまざまなアイデアをご覧ください。 [共同作成ガイド](CONTRIBUTING.md)に、使用されている手順に関する説明があります。 または、関心のあるタスクの[問題リストaaaaa](https://github.com/dotnet/docs/issues)をご確認ください。
...
詳細については、「[.NET Foundation Code of Conduct aaa](https://dotnetfoundation.org/code-of-conduct)」(.NET Foundation の倫理規定) を参照してください。
